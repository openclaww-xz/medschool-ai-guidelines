...
Heads-up for parent merge: concurrent run-08 also saved the UChicago IM residency AI policy as raw/health-systems/uchicago-medicine--im-residency-clinical-ai-use-policy.md — duplicate of my uchicago-im-residency--clinical-ai-use-policy.md (same source URL). Related GME items already collected by other runs: pdf/ohsu-som--gme-48-ai-use-in-gme.pdf, pdf/uw-medicine--comp308-use-of-ai.pdf.
