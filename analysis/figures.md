...
Themes are keyword patterns applied to the `banned_uses` free text; a
...
```
    ...
    ## 
    ## locale:
    ## [1] en_US/C.UTF-8/en_US/C/en_US/en_US
    ## 
