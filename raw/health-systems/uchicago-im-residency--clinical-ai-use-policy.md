...
title: "Clinical AI Use Policy - UChicago Internal Medicine Residency Program"
...
Residents should
NEVER
put Protected Health Information (PHI) into non UCM approved AI models (Chat GPT, Claude, Gemini, DoxGPT etc) · Approved AI systems can be found on the UCM Intranet these include but are not limited to Phoenix AI, UpToDate, etc
