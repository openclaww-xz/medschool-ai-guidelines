---
source_url: "https://pharmd.ucsf.edu/policies/ai"
title: "Policy on Use of AI in Assessments and Deliverables (UCSF PharmD)"
...
.) Generative AI may invent sources. Documentation of AI use is always a best practice and may be required. When documentation is required, students are obligated to follow standard practices for documentation. (See
Appendix
.)
...
Example: background section of assignment
AI-4: Unregulated
...
. Examples of assessments or deliverables that might be classified AI-1 may include, but are not limited to:
...
In such an assessment or deliverable, students are restricted in either the types of AI tools that may be used, or on which aspects of the assignment AI may be employed. All use of AI must be appropriately acknowledged. (See
AI-3
.) The nature of the restrictions should be specified by the instructor. Examples of assessments or deliverables that might be classified AI-2 include, but are not limited to:
